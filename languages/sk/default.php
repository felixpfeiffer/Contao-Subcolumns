...
$GLOBALS['TL_LANG']['CTE']['subcolumns'] = array('Stĺpce','<img src="system/modules/subcolumns/html/example_de.png" alt="Example for Column-Sets" style="float:right;" />Stĺpce ponúkajú možnosť formátovať obsah do stĺpcov.');
...
$GLOBALS['TL_LANG']['MSC']['contentAfter'] = '<img src="system/modules/subcolumns/html/down.gif" alt="" style="float:left;" />Vložte všetok obsah %s stĺpca za tento element.';
